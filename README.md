...
בנוסף, יש לממש פונקציה בשם `take_card` - לקיחת קלף-עיר כלשהו מהקופה.
פעולה זו מדמה את התהליך שבו השחקן מקבל קלפים מהקופה בתחילת המשחק או במהלכו.

יש רק קלף אחד של כל עיר, ולכן אם מבצעים פעולת
`take_card`
על קלף שכבר נמצא בידי השחקן, לא יהיה כל שינוי במצב השחקן (אין צורך לזרוק חריגה במקרה זה).
